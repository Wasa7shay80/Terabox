...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002432536305"))
...
#Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://Terabox:Terabox8080@terabox.hxryx.mongodb.net/?retryWrites=true&w=majority")
